...
namespace LibraryMVC.Controllers
{
    ...
    {
        private readonly Library1DbContext _context;

        public BooksController(Library1DbContext context)
        {
            _context = context;
        }
        ...
        {
            var library1DbContext = _context.Books.Include(b => b.Author);
            return View(await library1DbContext.ToListAsync());
        }
